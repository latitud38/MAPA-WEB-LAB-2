...
//ol.proj.get("EPSG:32718").setExtent([672206.844324, 5921814.221101, 678836.799836, 5925689.871627]);
var wms_layers = [];
...
lyr_BARRIOSSELECCIONADOS_1.set('fieldLabels', {'Id': 'no label', 'Nombre': 'inline label - always visible', 'Area': 'inline label - always visible', 'hab_m2': 'inline label - always visible', 'Sum_Poblac': 'inline label - always visible', 'av_hab': 'inline label - always visible', 'Long_tLic': 'inline label - always visible', 'Long_tNLic': 'inline label - always visible', 'Suma_Trans': 'inline label - always visible', 'porc_cober': 'inline label - always visible', 'Distance': 'inline label - always visible', 'LongcicloK': 'inline label - always visible', 'Long_rvial': 'inline label - always visible', });
...
lyr_ParqueMiradorLosPinos_4.set('fieldLabels', {'id': 'no label', 'Barrio_Aso': 'inline label - always visible', 'Atrac_Tur': 'header label - always visible', 'Descrip': 'inline label - always visible', 'Tipo': 'inline label - always visible', 'Coords': 'inline label - always visible', });
...
lyr_LagunaLoMendez_6.set('fieldLabels', {'id': 'no label', 'Barrio_Aso': 'inline label - always visible', 'Atrac_Tur': 'header label - always visible', 'Descrip': 'inline label - always visible', 'Tipo': 'inline label - always visible', 'Coords': 'inline label - always visible', });
...
lyr_HumedalPichirume_8.set('fieldLabels', {'id': 'no label', 'Barrio_Aso': 'inline label - always visible', 'Atrac_Tur': 'header label - always visible', 'Descrip': 'inline label - always visible', 'Tipo': 'inline label - always visible', 'Coords': 'inline label - always visible', });
lyr_CerroAmarillo_9.set('fieldLabels', {'id': 'no label', 'Barrio_Aso': 'inline label - always visible', 'Descrip': 'inline label - always visible', 'Tipo': 'inline label - always visible', 'Coords': 'inline label - always visible', 'Atrac_Tur': 'header label - always visible', });
lyr_ParqueZooConcepcion_10.set('fieldLabels', {'id': 'no label', 'Barrio_Aso': 'inline label - always visible', 'Atrac_Tur': 'header label - always visible', 'Tipo': 'inline label - always visible', 'Coords': 'inline label - always visible', 'Descrip': 'inline label - always visible', });
...
lyr_ParqueAlfredoSalgado_12.set('fieldLabels', {'id': 'no label', 'Barrio_Aso': 'inline label - always visible', 'Atrac_Tur': 'header label - always visible', 'Descrip': 'inline label - always visible', 'Tipo': 'inline label - always visible', 'Coords': 'inline label - always visible', });
...
lyr_HumedalLosBatros_14.set('fieldLabels', {'id': 'no label', 'Barrio_Aso': 'inline label - always visible', 'Atrac_Tur': 'header label - always visible', 'Tipo': 'inline label - always visible', 'Coords': 'inline label - always visible', 'Descrip': 'inline label - always visible', });
lyr_EstadioMunicipalEsterRoa_15.set('fieldLabels', {'id': 'no label', 'Barrio_Aso': 'inline label - always visible', 'Atrac_Tur': 'header label - always visible', 'Descrip': 'inline label - always visible', 'Tipo': 'inline label - always visible', 'Coords': 'inline label - always visible', 'Video': 'inline label - always visible', });
lyr_LagunalasTresPascualas_16.set('fieldLabels', {'id': 'no label', 'Atrac_Tur': 'header label - always visible', 'Descrip': 'inline label - always visible', 'Tipo': 'inline label - always visible', 'Coords': 'inline label - always visible', 'Barrio_Aso': 'inline label - always visible', });
...
lyr_BarrioEstacin_18.set('fieldLabels', {'id': 'no label', 'Barrio_Aso': 'inline label - always visible', 'Atrac_Tur': 'header label - always visible', 'Descrip': 'inline label - always visible', 'Tipo': 'inline label - always visible', 'Coords': 'inline label - always visible', });
