...
var style_MinaChiflondelDIablo_20 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (size == 1) { // If cluster has one feature
        ...
        if (feature.get("Atract_Tur") !== null) {
            labelText = String(feature.get("Atract_Tur"));
        }
    ...
    var style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 5.769230769230768 + size,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(35,35,35,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.0}), fill: new ol.style.Fill({color: 'rgba(4,26,207,1.0)'})}),
